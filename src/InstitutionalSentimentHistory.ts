...
export const InstitutionalSentimentHistory = {
   ...
   */
  async create(
    props: InstitutionalSentimentHistoryType,
    globalClient?: ApolloClientType<NormalizedCacheObject>
  ): Promise<InstitutionalSentimentHistoryType> {
      ...
      try {
        ...
        const variables = {
          data: {
            ...
            overallSentiment:
              props.overallSentiment !== undefined
                ? props.overallSentiment
                : undefined,
            confidence:
              props.confidence !== undefined ? props.confidence : undefined,
            secFilingsSentiment:
              props.secFilingsSentiment !== undefined
                ? props.secFilingsSentiment
                : undefined,
            secFilingsConfidence:
              props.secFilingsConfidence !== undefined
                ? props.secFilingsConfidence
                : undefined,
            secInsiderTradingSignal:
              props.secInsiderTradingSignal !== undefined
                ? props.secInsiderTradingSignal
                : undefined,
            secInstitutionalFlowSignal:
              props.secInstitutionalFlowSignal !== undefined
                ? props.secInstitutionalFlowSignal
                : undefined,
            secAnalystRevisionsSignal:
              props.secAnalystRevisionsSignal !== undefined
                ? props.secAnalystRevisionsSignal
                : undefined,
            secGuidanceChangesSignal:
              props.secGuidanceChangesSignal !== undefined
                ? props.secGuidanceChangesSignal
                : undefined,
            secShortTrend:
              props.secShortTrend !== undefined
                ? props.secShortTrend
                : undefined,
            secMediumTrend:
              props.secMediumTrend !== undefined
                ? props.secMediumTrend
                : undefined,
            secLongTrend:
              props.secLongTrend !== undefined ? props.secLongTrend : undefined,
            insiderTradingOverall:
              props.insiderTradingOverall !== undefined
                ? props.insiderTradingOverall
                : undefined,
            insiderBuyingSentiment:
              props.insiderBuyingSentiment !== undefined
                ? props.insiderBuyingSentiment
                : undefined,
            insiderSellingSentiment:
              props.insiderSellingSentiment !== undefined
                ? props.insiderSellingSentiment
                : undefined,
            insiderSignificantCount:
              props.insiderSignificantCount !== undefined
                ? props.insiderSignificantCount
                : undefined,
            insiderTotalValue:
              props.insiderTotalValue !== undefined
                ? props.insiderTotalValue
                : undefined,
            insiderRecentActivity:
              props.insiderRecentActivity !== undefined
                ? props.insiderRecentActivity
                : undefined,
            analystOverall:
              props.analystOverall !== undefined
                ? props.analystOverall
                : undefined,
            analystAverageRating:
              props.analystAverageRating !== undefined
                ? props.analystAverageRating
                : undefined,
            analystAverageTarget:
              props.analystAverageTarget !== undefined
                ? props.analystAverageTarget
                : undefined,
            analystUpgrades:
              props.analystUpgrades !== undefined
                ? props.analystUpgrades
                : undefined,
            analystDowngrades:
              props.analystDowngrades !== undefined
                ? props.analystDowngrades
                : undefined,
            analystTargetChanges:
              props.analystTargetChanges !== undefined
                ? props.analystTargetChanges
                : undefined,
            analystConsensus:
              props.analystConsensus !== undefined
                ? props.analystConsensus
                : undefined,
            optionsFlowOverall:
              props.optionsFlowOverall !== undefined
                ? props.optionsFlowOverall
                : undefined,
            optionsCallFlow:
              props.optionsCallFlow !== undefined
                ? props.optionsCallFlow
                : undefined,
            optionsPutFlow:
              props.optionsPutFlow !== undefined
                ? props.optionsPutFlow
                : undefined,
            optionsUnusualActivity:
              props.optionsUnusualActivity !== undefined
                ? props.optionsUnusualActivity
                : undefined,
            optionsBlockActivity:
              props.optionsBlockActivity !== undefined
                ? props.optionsBlockActivity
                : undefined,
            optionsSweepActivity:
              props.optionsSweepActivity !== undefined
                ? props.optionsSweepActivity
                : undefined,
            optionsSentimentScore:
              props.optionsSentimentScore !== undefined
                ? props.optionsSentimentScore
                : undefined,
            institutionalFlowOverall:
              props.institutionalFlowOverall !== undefined
                ? props.institutionalFlowOverall
                : undefined,
            institutionalNetFlow:
              props.institutionalNetFlow !== undefined
                ? props.institutionalNetFlow
                : undefined,
            institutionalIncreasingPositions:
              props.institutionalIncreasingPositions !== undefined
                ? props.institutionalIncreasingPositions
                : undefined,
            institutionalDecreasingPositions:
              props.institutionalDecreasingPositions !== undefined
                ? props.institutionalDecreasingPositions
                : undefined,
            institutionalNewPositions:
              props.institutionalNewPositions !== undefined
                ? props.institutionalNewPositions
                : undefined,
            institutionalClosedPositions:
              props.institutionalClosedPositions !== undefined
                ? props.institutionalClosedPositions
                : undefined,
            darkPoolOverall:
              props.darkPoolOverall !== undefined
                ? props.darkPoolOverall
                : undefined,
            darkPoolBuyPressure:
              props.darkPoolBuyPressure !== undefined
                ? props.darkPoolBuyPressure
                : undefined,
            darkPoolSellPressure:
              props.darkPoolSellPressure !== undefined
                ? props.darkPoolSellPressure
                : undefined,
            darkPoolVolumeSignificance:
              props.darkPoolVolumeSignificance !== undefined
                ? props.darkPoolVolumeSignificance
                : undefined,
            darkPoolPriceImpact:
              props.darkPoolPriceImpact !== undefined
                ? props.darkPoolPriceImpact
                : undefined,
          },
        };
        ...
        if (
          response &&
          response.data &&
          response.data.createOneInstitutionalSentimentHistory
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const CREATE_MANY_INSTITUTIONALSENTIMENTHISTORY = gql`
          mutation createManyInstitutionalSentimentHistory(
            $data: [InstitutionalSentimentHistoryCreateManyInput!]!
          ) {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            overallSentiment:
              prop.overallSentiment !== undefined
                ? prop.overallSentiment
                : undefined,
            confidence:
              prop.confidence !== undefined ? prop.confidence : undefined,
            secFilingsSentiment:
              prop.secFilingsSentiment !== undefined
                ? prop.secFilingsSentiment
                : undefined,
            secFilingsConfidence:
              prop.secFilingsConfidence !== undefined
                ? prop.secFilingsConfidence
                : undefined,
            secInsiderTradingSignal:
              prop.secInsiderTradingSignal !== undefined
                ? prop.secInsiderTradingSignal
                : undefined,
            secInstitutionalFlowSignal:
              prop.secInstitutionalFlowSignal !== undefined
                ? prop.secInstitutionalFlowSignal
                : undefined,
            secAnalystRevisionsSignal:
              prop.secAnalystRevisionsSignal !== undefined
                ? prop.secAnalystRevisionsSignal
                : undefined,
            secGuidanceChangesSignal:
              prop.secGuidanceChangesSignal !== undefined
                ? prop.secGuidanceChangesSignal
                : undefined,
            secShortTrend:
              prop.secShortTrend !== undefined ? prop.secShortTrend : undefined,
            secMediumTrend:
              prop.secMediumTrend !== undefined
                ? prop.secMediumTrend
                : undefined,
            secLongTrend:
              prop.secLongTrend !== undefined ? prop.secLongTrend : undefined,
            insiderTradingOverall:
              prop.insiderTradingOverall !== undefined
                ? prop.insiderTradingOverall
                : undefined,
            insiderBuyingSentiment:
              prop.insiderBuyingSentiment !== undefined
                ? prop.insiderBuyingSentiment
                : undefined,
            insiderSellingSentiment:
              prop.insiderSellingSentiment !== undefined
                ? prop.insiderSellingSentiment
                : undefined,
            insiderSignificantCount:
              prop.insiderSignificantCount !== undefined
                ? prop.insiderSignificantCount
                : undefined,
            insiderTotalValue:
              prop.insiderTotalValue !== undefined
                ? prop.insiderTotalValue
                : undefined,
            insiderRecentActivity:
              prop.insiderRecentActivity !== undefined
                ? prop.insiderRecentActivity
                : undefined,
            analystOverall:
              prop.analystOverall !== undefined
                ? prop.analystOverall
                : undefined,
            analystAverageRating:
              prop.analystAverageRating !== undefined
                ? prop.analystAverageRating
                : undefined,
            analystAverageTarget:
              prop.analystAverageTarget !== undefined
                ? prop.analystAverageTarget
                : undefined,
            analystUpgrades:
              prop.analystUpgrades !== undefined
                ? prop.analystUpgrades
                : undefined,
            analystDowngrades:
              prop.analystDowngrades !== undefined
                ? prop.analystDowngrades
                : undefined,
            analystTargetChanges:
              prop.analystTargetChanges !== undefined
                ? prop.analystTargetChanges
                : undefined,
            analystConsensus:
              prop.analystConsensus !== undefined
                ? prop.analystConsensus
                : undefined,
            optionsFlowOverall:
              prop.optionsFlowOverall !== undefined
                ? prop.optionsFlowOverall
                : undefined,
            optionsCallFlow:
              prop.optionsCallFlow !== undefined
                ? prop.optionsCallFlow
                : undefined,
            optionsPutFlow:
              prop.optionsPutFlow !== undefined
                ? prop.optionsPutFlow
                : undefined,
            optionsUnusualActivity:
              prop.optionsUnusualActivity !== undefined
                ? prop.optionsUnusualActivity
                : undefined,
            optionsBlockActivity:
              prop.optionsBlockActivity !== undefined
                ? prop.optionsBlockActivity
                : undefined,
            optionsSweepActivity:
              prop.optionsSweepActivity !== undefined
                ? prop.optionsSweepActivity
                : undefined,
            optionsSentimentScore:
              prop.optionsSentimentScore !== undefined
                ? prop.optionsSentimentScore
                : undefined,
            institutionalFlowOverall:
              prop.institutionalFlowOverall !== undefined
                ? prop.institutionalFlowOverall
                : undefined,
            institutionalNetFlow:
              prop.institutionalNetFlow !== undefined
                ? prop.institutionalNetFlow
                : undefined,
            institutionalIncreasingPositions:
              prop.institutionalIncreasingPositions !== undefined
                ? prop.institutionalIncreasingPositions
                : undefined,
            institutionalDecreasingPositions:
              prop.institutionalDecreasingPositions !== undefined
                ? prop.institutionalDecreasingPositions
                : undefined,
            institutionalNewPositions:
              prop.institutionalNewPositions !== undefined
                ? prop.institutionalNewPositions
                : undefined,
            institutionalClosedPositions:
              prop.institutionalClosedPositions !== undefined
                ? prop.institutionalClosedPositions
                : undefined,
            darkPoolOverall:
              prop.darkPoolOverall !== undefined
                ? prop.darkPoolOverall
                : undefined,
            darkPoolBuyPressure:
              prop.darkPoolBuyPressure !== undefined
                ? prop.darkPoolBuyPressure
                : undefined,
            darkPoolSellPressure:
              prop.darkPoolSellPressure !== undefined
                ? prop.darkPoolSellPressure
                : undefined,
            darkPoolVolumeSignificance:
              prop.darkPoolVolumeSignificance !== undefined
                ? prop.darkPoolVolumeSignificance
                : undefined,
            darkPoolPriceImpact:
              prop.darkPoolPriceImpact !== undefined
                ? prop.darkPoolPriceImpact
                : undefined,
          })),
        };
        ...
        if (
          response &&
          response.data &&
          response.data.createManyInstitutionalSentimentHistory
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.updateOneInstitutionalSentimentHistory
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.upsertOneInstitutionalSentimentHistory
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const UPDATE_MANY_INSTITUTIONALSENTIMENTHISTORY = gql`
          mutation updateManyInstitutionalSentimentHistory(
            $data: [InstitutionalSentimentHistoryCreateManyInput!]!
          ) {
        ...
        if (
          response &&
          response.data &&
          response.data.updateManyInstitutionalSentimentHistory
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const DELETE_ONE_INSTITUTIONALSENTIMENTHISTORY = gql`
          mutation deleteOneInstitutionalSentimentHistory(
            $where: InstitutionalSentimentHistoryWhereUniqueInput!
          ) {
        ...
        if (
          response &&
          response.data &&
          response.data.deleteOneInstitutionalSentimentHistory
        ) {
  ...
  async get(
    ...
    globalClient?: ApolloClientType<NormalizedCacheObject>,
    whereInput?: any
  ): Promise<InstitutionalSentimentHistoryType | null> {
    // Maximum number of retries for database connection issues
    const MAX_RETRIES = 3;
    let retryCount = 0;
    let lastError: any = null;
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.institutionalsentimenthistories
        ) {

...
export const LlmConfiguration = {
   ...
   */
  async create(
    props: LlmConfigurationType,
    globalClient?: ApolloClientType<NormalizedCacheObject>
  ): Promise<LlmConfigurationType> {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
          ...
          data: {
            defaultProvider:
              props.defaultProvider !== undefined
                ...
                : undefined,
            miniProvider:
              props.miniProvider !== undefined ? props.miniProvider : undefined,
            normalProvider:
              props.normalProvider !== undefined
                ? props.normalProvider
                : undefined,
            advancedProvider:
              props.advancedProvider !== undefined
                ? props.advancedProvider
                : undefined,
            miniModel:
              props.miniModel !== undefined ? props.miniModel : undefined,
            normalModel:
              props.normalModel !== undefined ? props.normalModel : undefined,
            advancedModel:
              props.advancedModel !== undefined
                ? props.advancedModel
                : undefined,
            openaiApiKey:
              props.openaiApiKey !== undefined ? props.openaiApiKey : undefined,
            anthropicApiKey:
              props.anthropicApiKey !== undefined
                ? props.anthropicApiKey
                : undefined,
            deepseekApiKey:
              props.deepseekApiKey !== undefined
                ? props.deepseekApiKey
                : undefined,
            kimiApiKey:
              props.kimiApiKey !== undefined ? props.kimiApiKey : undefined,
            qwenApiKey:
              props.qwenApiKey !== undefined ? props.qwenApiKey : undefined,
            xaiApiKey:
              props.xaiApiKey !== undefined ? props.xaiApiKey : undefined,
            geminiApiKey:
              props.geminiApiKey !== undefined ? props.geminiApiKey : undefined,
            user: props.user
        ...
        if (
          response &&
          response.data &&
          response.data.createOneLlmConfiguration
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const CREATE_MANY_LLMCONFIGURATION = gql`
          mutation createManyLlmConfiguration(
            $data: [LlmConfigurationCreateManyInput!]!
          ) {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            defaultProvider:
              prop.defaultProvider !== undefined
                ? prop.defaultProvider
                : undefined,
            miniProvider:
              prop.miniProvider !== undefined ? prop.miniProvider : undefined,
            normalProvider:
              prop.normalProvider !== undefined
                ? prop.normalProvider
                : undefined,
            advancedProvider:
              prop.advancedProvider !== undefined
                ? prop.advancedProvider
                : undefined,
            miniModel:
              prop.miniModel !== undefined ? prop.miniModel : undefined,
            normalModel:
              prop.normalModel !== undefined ? prop.normalModel : undefined,
            advancedModel:
              prop.advancedModel !== undefined ? prop.advancedModel : undefined,
            openaiApiKey:
              prop.openaiApiKey !== undefined ? prop.openaiApiKey : undefined,
            anthropicApiKey:
              prop.anthropicApiKey !== undefined
                ? prop.anthropicApiKey
                : undefined,
            deepseekApiKey:
              prop.deepseekApiKey !== undefined
                ? prop.deepseekApiKey
                : undefined,
            kimiApiKey:
              prop.kimiApiKey !== undefined ? prop.kimiApiKey : undefined,
            qwenApiKey:
              prop.qwenApiKey !== undefined ? prop.qwenApiKey : undefined,
            xaiApiKey:
              prop.xaiApiKey !== undefined ? prop.xaiApiKey : undefined,
            geminiApiKey:
              prop.geminiApiKey !== undefined ? prop.geminiApiKey : undefined,
          })),
        };
        ...
        if (
          response &&
          response.data &&
          response.data.createManyLlmConfiguration
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
          ...
          data: {
            ...
            advancedProvider:
              props.advancedProvider !== undefined
                ...
                : undefined,
            miniModel:
              props.miniModel !== undefined
                ? {
                    set: props.miniModel,
                  }
                : undefined,
            normalModel:
              props.normalModel !== undefined
                ? {
            ...
            deepseekApiKey:
              props.deepseekApiKey !== undefined
                ...
                : undefined,
            kimiApiKey:
              props.kimiApiKey !== undefined
                ? {
                    set: props.kimiApiKey,
                  }
                : undefined,
            qwenApiKey:
              props.qwenApiKey !== undefined
                ? {
                    set: props.qwenApiKey,
                  }
                : undefined,
            xaiApiKey:
              props.xaiApiKey !== undefined
                ? {
                    set: props.xaiApiKey,
                  }
                : undefined,
            geminiApiKey:
              props.geminiApiKey !== undefined
                ? {
        ...
        if (
          response &&
          response.data &&
          response.data.updateOneLlmConfiguration
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.upsertOneLlmConfiguration
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const UPDATE_MANY_LLMCONFIGURATION = gql`
          mutation updateManyLlmConfiguration(
            $data: [LlmConfigurationCreateManyInput!]!
          ) {
          ...
          data: {
            ...
            advancedProvider:
              prop.advancedProvider !== undefined
                ...
                : undefined,
            miniModel:
              prop.miniModel !== undefined
                ? {
                    set: prop.miniModel,
                  }
                : undefined,
            normalModel:
              prop.normalModel !== undefined
                ? {
                    set: prop.normalModel,
                  }
                : undefined,
            advancedModel:
              prop.advancedModel !== undefined
                ? {
            ...
            deepseekApiKey:
              prop.deepseekApiKey !== undefined
                ...
                : undefined,
            kimiApiKey:
              prop.kimiApiKey !== undefined
                ? {
                    set: prop.kimiApiKey,
                  }
                : undefined,
            qwenApiKey:
              prop.qwenApiKey !== undefined
                ? {
                    set: prop.qwenApiKey,
                  }
                : undefined,
            xaiApiKey:
              prop.xaiApiKey !== undefined
                ? {
                    set: prop.xaiApiKey,
                  }
                : undefined,
            geminiApiKey:
              prop.geminiApiKey !== undefined
                ? {
        ...
        if (
          response &&
          response.data &&
          response.data.updateManyLlmConfiguration
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const DELETE_ONE_LLMCONFIGURATION = gql`
          mutation deleteOneLlmConfiguration(
        ...
        if (
          response &&
          response.data &&
          response.data.deleteOneLlmConfiguration
        ) {
  ...
  async get(
    ...
    globalClient?: ApolloClientType<NormalizedCacheObject>,
    whereInput?: any
  ): Promise<LlmConfigurationType | null> {
    // Maximum number of retries for database connection issues
    const MAX_RETRIES = 2;
    let retryCount = 0;
    let lastError: any = null;

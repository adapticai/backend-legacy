...
export const AccountLinkingRequest = {
   ...
   */
  async create(
    props: AccountLinkingRequestType,
    globalClient?: ApolloClientType<NormalizedCacheObject>
  ): Promise<AccountLinkingRequestType> {
      ...
      try {
        ...
        const variables = {
          data: {
            ...
            verificationToken:
              props.verificationToken !== undefined
                ? props.verificationToken
                : undefined,
            userAgent:
              props.userAgent !== undefined ? props.userAgent : undefined,
            ipAddress:
              props.ipAddress !== undefined ? props.ipAddress : undefined,
            expiresAt:
              props.expiresAt !== undefined ? props.expiresAt : undefined,
            verifiedAt:
              props.verifiedAt !== undefined ? props.verifiedAt : undefined,
            approvedAt:
              props.approvedAt !== undefined ? props.approvedAt : undefined,
            rejectedAt:
              props.rejectedAt !== undefined ? props.rejectedAt : undefined,
            user: props.user
        ...
        if (
          response &&
          response.data &&
          response.data.createOneAccountLinkingRequest
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const CREATE_MANY_ACCOUNTLINKINGREQUEST = gql`
          mutation createManyAccountLinkingRequest(
            $data: [AccountLinkingRequestCreateManyInput!]!
          ) {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            verificationToken:
              prop.verificationToken !== undefined
                ? prop.verificationToken
                : undefined,
            userAgent:
              prop.userAgent !== undefined ? prop.userAgent : undefined,
            ipAddress:
              prop.ipAddress !== undefined ? prop.ipAddress : undefined,
            expiresAt:
              prop.expiresAt !== undefined ? prop.expiresAt : undefined,
            verifiedAt:
              prop.verifiedAt !== undefined ? prop.verifiedAt : undefined,
            approvedAt:
              prop.approvedAt !== undefined ? prop.approvedAt : undefined,
            rejectedAt:
              prop.rejectedAt !== undefined ? prop.rejectedAt : undefined,
          })),
        };
        ...
        if (
          response &&
          response.data &&
          response.data.createManyAccountLinkingRequest
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.updateOneAccountLinkingRequest
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.upsertOneAccountLinkingRequest
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const UPDATE_MANY_ACCOUNTLINKINGREQUEST = gql`
          mutation updateManyAccountLinkingRequest(
            $data: [AccountLinkingRequestCreateManyInput!]!
          ) {
          ...
          data: {
            ...
            expiresAt:
              prop.expiresAt !== undefined
                ...
                : undefined,
            verifiedAt:
              prop.verifiedAt !== undefined
                ? {
                    set: prop.verifiedAt,
                  }
                : undefined,
            approvedAt:
              prop.approvedAt !== undefined
                ? {
                    set: prop.approvedAt,
                  }
                : undefined,
            rejectedAt:
              prop.rejectedAt !== undefined
                ? {
                    set: prop.rejectedAt,
                  }
                : undefined,
        ...
        if (
          response &&
          response.data &&
          response.data.updateManyAccountLinkingRequest
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const DELETE_ONE_ACCOUNTLINKINGREQUEST = gql`
          mutation deleteOneAccountLinkingRequest(
            $where: AccountLinkingRequestWhereUniqueInput!
          ) {
        ...
        if (
          response &&
          response.data &&
          response.data.deleteOneAccountLinkingRequest
        ) {
  ...
  async get(
    ...
    globalClient?: ApolloClientType<NormalizedCacheObject>,
    whereInput?: any
  ): Promise<AccountLinkingRequestType | null> {
    // Maximum number of retries for database connection issues
    const MAX_RETRIES = 3;
    let retryCount = 0;
    let lastError: any = null;

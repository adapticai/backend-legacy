...
export const User = {
   ...
   */
  async get(props: UserType, client: ApolloClient<NormalizedCacheObject>): Promise<UserType | null> {
    const GET_USER = gql`
   ...
   */
  async findMany(props: UserType, client: ApolloClient<NormalizedCacheObject>): Promise<UserType[] | null> {

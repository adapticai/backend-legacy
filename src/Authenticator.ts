    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const variables = {
          data: {
            credentialID:
              props.credentialID !== undefined ? props.credentialID : undefined,
            publicKey:
              props.publicKey !== undefined ? props.publicKey : undefined,
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const CREATE_MANY_AUTHENTICATOR = gql`
          mutation createManyAuthenticator(
            $data: [AuthenticatorCreateManyInput!]!
          ) {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            credentialID:
              prop.credentialID !== undefined ? prop.credentialID : undefined,
            publicKey:
              prop.publicKey !== undefined ? prop.publicKey : undefined,
        ...
        if (
          response &&
          response.data &&
          response.data.createManyAuthenticator
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const UPDATE_MANY_AUTHENTICATOR = gql`
          mutation updateManyAuthenticator(
            $data: [AuthenticatorCreateManyInput!]!
          ) {
          ...
          data: {
            id:
              prop.id !== undefined
                ...
                : undefined,
            credentialID:
              prop.credentialID !== undefined
                ? {
                    set: prop.credentialID,
                  }
                : undefined,
            publicKey:
              prop.publicKey !== undefined
                ? {
                    set: prop.publicKey,
                  }
                : undefined,
            counter:
              prop.counter !== undefined
                ? {
                    set: prop.counter,
                  }
                : undefined,
        ...
        if (
          response &&
          response.data &&
          response.data.updateManyAuthenticator
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const DELETE_ONE_AUTHENTICATOR = gql`
          mutation deleteOneAuthenticator(

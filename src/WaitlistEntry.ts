                      ...
                      create: {
                        ...
                        jobTitle:
                          props.reviewedBy.jobTitle !== undefined
                            ...
                            : undefined,
                        currentAccount:
                          props.reviewedBy.currentAccount !== undefined
                            ? props.reviewedBy.currentAccount
                            : undefined,
                        plan:
                        ...
                        alpacaAccounts: props.reviewedBy.alpacaAccounts
                          ? Array.isArray(props.reviewedBy.alpacaAccounts) &&
                            props.reviewedBy.alpacaAccounts.length > 0 &&
                            props.reviewedBy.alpacaAccounts.every(
                              (item: any) =>
                                typeof item === 'object' &&
                                'id' in item &&
                                Object.keys(item).length === 1
                            ...
                            ? {
                                connect: props.reviewedBy.alpacaAccounts.map(
                                  (item: any) => ({
                                    id: item.id,
                                  })
                                ),
                            ...
                            : {
                                connectOrCreate:
                                  props.reviewedBy.alpacaAccounts.map(
                                    (item: any) => ({
                                      where: {
                                        id:
                                          item.id !== undefined
                      ...
                      update: {
                        ...
                        alpacaAccounts: props.reviewedBy.alpacaAccounts
                          ? Array.isArray(props.reviewedBy.alpacaAccounts) &&
                            ...
                            : {
                                upsert: props.reviewedBy.alpacaAccounts.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined
                ...
                : {
                    upsert: {
                      ...
                      update: {
                        ...
                        jobTitle:
                          prop.reviewedBy.jobTitle !== undefined
                            ...
                            : undefined,
                        currentAccount:
                          prop.reviewedBy.currentAccount !== undefined
                            ? {
                        ...
                        alpacaAccounts: prop.reviewedBy.alpacaAccounts
                          ? Array.isArray(prop.reviewedBy.alpacaAccounts) &&
                            prop.reviewedBy.alpacaAccounts.length > 0 &&
                            prop.reviewedBy.alpacaAccounts.every(
                              (item: any) =>
                                typeof item === 'object' &&
                                ('id' in item || 'symbol' in item) &&
                                Object.keys(item).length === 1
                            ...
                            ? {
                                connect: prop.reviewedBy.alpacaAccounts.map(
                                  (item: any) => ({
                                    id: item.id,
                                  })
                                ),
                            ...
                            : {
                                upsert: prop.reviewedBy.alpacaAccounts.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined
                      ...
                      create: {
                        ...
                        currentAccount:
                          prop.reviewedBy.currentAccount !== undefined
                            ? prop.reviewedBy.currentAccount
                            : undefined,
                        plan:
                          prop.reviewedBy.plan !== undefined
                        ...
                        alpacaAccounts: prop.reviewedBy.alpacaAccounts
                          ? Array.isArray(prop.reviewedBy.alpacaAccounts) &&
                            ...
                            : {
                                connectOrCreate:
                                  prop.reviewedBy.alpacaAccounts.map(
                                    (item: any) => ({
                                      where: {
                                        id:
                                          item.id !== undefined

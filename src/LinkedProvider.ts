                    ...
                    connectOrCreate: {
                      ...
                      create: {
                        ...
                        dashboardLayouts: props.user.dashboardLayouts
                          ? Array.isArray(props.user.dashboardLayouts) &&
                            props.user.dashboardLayouts.length > 0 &&
                            props.user.dashboardLayouts.every(
                              (item: any) =>
                                typeof item === 'object' &&
                                'id' in item &&
                                Object.keys(item).length === 1
                            ...
                            ? {
                                connect: props.user.dashboardLayouts.map(
                                  (item: any) => ({
                                    id: item.id,
                                  })
                                ),
                            ...
                            : {
                                connectOrCreate:
                                  props.user.dashboardLayouts.map(
                                    (item: any) => ({
                                      where: {
                                        id:
                                          item.id !== undefined
                      ...
                      update: {
                        ...
                        dashboardLayouts: props.user.dashboardLayouts
                          ? Array.isArray(props.user.dashboardLayouts) &&
                            ...
                            : {
                                upsert: props.user.dashboardLayouts.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined
                    ...
                    upsert: {
                      ...
                      update: {
                        ...
                        dashboardLayouts: prop.user.dashboardLayouts
                          ? Array.isArray(prop.user.dashboardLayouts) &&
                            prop.user.dashboardLayouts.length > 0 &&
                            prop.user.dashboardLayouts.every(
                              (item: any) =>
                                typeof item === 'object' &&
                                ('id' in item || 'symbol' in item) &&
                                Object.keys(item).length === 1
                            ...
                            ? {
                                connect: prop.user.dashboardLayouts.map(
                                  (item: any) => ({
                                    id: item.id,
                                  })
                                ),
                            ...
                            : {
                                upsert: prop.user.dashboardLayouts.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined
                      ...
                      create: {
                        ...
                        dashboardLayouts: prop.user.dashboardLayouts
                          ? Array.isArray(prop.user.dashboardLayouts) &&
                            ...
                            : {
                                connectOrCreate: prop.user.dashboardLayouts.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined

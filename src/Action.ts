      ...
      try {
        ...
        const variables = {
          data: {
            ...
            alpacaOrderId:
              props.alpacaOrderId !== undefined
                ? props.alpacaOrderId
                : undefined,
            trade: props.trade
              ? typeof props.trade === 'object' &&
                Object.keys(props.trade).length === 1 &&
                Object.keys(props.trade)[0] === 'id'
                ? {
                    connect: {
                      id: props.trade.id,
                    },
                ...
                : {
                    connectOrCreate: {
                      where: {
                        id:
                          props.trade.id !== undefined
                            ? props.trade.id
                            : undefined,
                        alpacaAccountId:
                          props.trade.alpacaAccountId !== undefined
                            ? {
                                equals: props.trade.alpacaAccountId,
                              }
                            : undefined,
                        symbol:
                          props.trade.symbol !== undefined
                            ? {
                      ...
                      create: {
                        alpacaAccountId:
                          props.trade.alpacaAccountId !== undefined
                            ? props.trade.alpacaAccountId
                            : undefined,
                        signal:
                          props.trade.signal !== undefined
                            ? props.trade.signal
                            : undefined,
                        strategy:
                          props.trade.strategy !== undefined
                            ? props.trade.strategy
                            : undefined,
                        analysis:
                          props.trade.analysis !== undefined
                            ? props.trade.analysis
                            : undefined,
                        summary:
                          props.trade.summary !== undefined
                            ? props.trade.summary
                            : undefined,
                        confidence:
                          props.trade.confidence !== undefined
                            ? props.trade.confidence
                            : undefined,
                        timestamp:
                          props.trade.timestamp !== undefined
                            ? props.trade.timestamp
                            : undefined,
                        status:
                          props.trade.status !== undefined
                            ? props.trade.status
                            : undefined,
                        deletedAt:
                          props.trade.deletedAt !== undefined
                            ? props.trade.deletedAt
                            : undefined,
                        symbol:
                          props.trade.symbol !== undefined
                            ? props.trade.symbol
                            : undefined,
                        entryPrice:
                          props.trade.entryPrice !== undefined
                            ? props.trade.entryPrice
                            : undefined,
                        exitPrice:
                          props.trade.exitPrice !== undefined
                            ? props.trade.exitPrice
                            : undefined,
                        entryQty:
                          props.trade.entryQty !== undefined
                            ? props.trade.entryQty
                            : undefined,
                        exitQty:
                          props.trade.exitQty !== undefined
                            ? props.trade.exitQty
                            : undefined,
                        entryValue:
                          props.trade.entryValue !== undefined
                            ? props.trade.entryValue
                            : undefined,
                        exitValue:
                          props.trade.exitValue !== undefined
                            ? props.trade.exitValue
                            : undefined,
                        entryTime:
                          props.trade.entryTime !== undefined
                            ? props.trade.entryTime
                            : undefined,
                        exitTime:
                          props.trade.exitTime !== undefined
                            ? props.trade.exitTime
                            : undefined,
                        pnlAmount:
                          props.trade.pnlAmount !== undefined
                            ? props.trade.pnlAmount
                            : undefined,
                        pnlPercent:
                          props.trade.pnlPercent !== undefined
                            ? props.trade.pnlPercent
                            : undefined,
                        durationMinutes:
                          props.trade.durationMinutes !== undefined
                            ? props.trade.durationMinutes
                            : undefined,
                        marketPhase:
                          props.trade.marketPhase !== undefined
                            ? props.trade.marketPhase
                            : undefined,
                        marketVolatility:
                          props.trade.marketVolatility !== undefined
                            ? props.trade.marketVolatility
                            : undefined,
                        sessionHorizonMinutes:
                          props.trade.sessionHorizonMinutes !== undefined
                            ? props.trade.sessionHorizonMinutes
                            : undefined,
                        thresholdsJson:
                          props.trade.thresholdsJson !== undefined
                            ? props.trade.thresholdsJson
                            : undefined,
                      },
                    },
                  }
      ...
      try {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            alpacaOrderId:
              prop.alpacaOrderId !== undefined ? prop.alpacaOrderId : undefined,
          })),
        };
          ...
          data: {
            ...
            trade: props.trade
              ? typeof props.trade === 'object' &&
                Object.keys(props.trade).length === 1 &&
                (Object.keys(props.trade)[0] === 'id' ||
                  Object.keys(props.trade)[0] === 'symbol')
                ? {
                    connect: {
                      id: props.trade.id,
                    },
          ...
          data: {
            ...
            deletedAt:
              prop.deletedAt !== undefined
                ...
                : undefined,
            alpacaOrderId:
              prop.alpacaOrderId !== undefined
                ? {
                    set: prop.alpacaOrderId,
                  }
                : undefined,
            trade: prop.trade
              ? typeof prop.trade === 'object' &&
                Object.keys(prop.trade).length === 1 &&
                (Object.keys(prop.trade)[0] === 'id' ||
                  Object.keys(prop.trade)[0] === 'symbol')
                ? {
                    connect: {
                      id: prop.trade.id,
                    },
                ...
                : {
                    upsert: {
                      where: {
                        id:
                          prop.trade.id !== undefined
                            ? {
                                equals: prop.trade.id,
                              }
                            : undefined,
                        alpacaAccountId:
                          prop.trade.alpacaAccountId !== undefined
                            ? {
                                equals: prop.trade.alpacaAccountId,
                              }
                            : undefined,
                        symbol:
                          prop.trade.symbol !== undefined
                            ? {
                      ...
                      update: {
                        ...
                        alpacaAccountId:
                          prop.trade.alpacaAccountId !== undefined
                            ...
                            : undefined,
                        signal:
                          prop.trade.signal !== undefined
                            ? {
                                set: prop.trade.signal,
                              }
                            : undefined,
                        strategy:
                          prop.trade.strategy !== undefined
                            ? {
                                set: prop.trade.strategy,
                              }
                            : undefined,
                        analysis:
                          prop.trade.analysis !== undefined
                            ? {
                                set: prop.trade.analysis,
                              }
                            : undefined,
                        summary:
                          prop.trade.summary !== undefined
                            ? {
                                set: prop.trade.summary,
                              }
                            : undefined,
                        confidence:
                          prop.trade.confidence !== undefined
                            ? {
                                set: prop.trade.confidence,
                              }
                            : undefined,
                        timestamp:
                          prop.trade.timestamp !== undefined
                            ? {
                                set: prop.trade.timestamp,
                              }
                            : undefined,
                        status:
                          prop.trade.status !== undefined
                            ? {
                                set: prop.trade.status,
                              }
                            : undefined,
                        deletedAt:
                          prop.trade.deletedAt !== undefined
                            ? {
                        ...
                        symbol:
                          prop.trade.symbol !== undefined
                            ...
                            : undefined,
                        entryPrice:
                          prop.trade.entryPrice !== undefined
                            ? {
                                set: prop.trade.entryPrice,
                              }
                            : undefined,
                        exitPrice:
                          prop.trade.exitPrice !== undefined
                            ? {
                                set: prop.trade.exitPrice,
                              }
                            : undefined,
                        entryQty:
                          prop.trade.entryQty !== undefined
                            ? {
                                set: prop.trade.entryQty,
                              }
                            : undefined,
                        exitQty:
                          prop.trade.exitQty !== undefined
                            ? {
                                set: prop.trade.exitQty,
                              }
                            : undefined,
                        entryValue:
                          prop.trade.entryValue !== undefined
                            ? {
                                set: prop.trade.entryValue,
                              }
                            : undefined,
                        exitValue:
                          prop.trade.exitValue !== undefined
                            ? {
                                set: prop.trade.exitValue,
                              }
                            : undefined,
                        entryTime:
                          prop.trade.entryTime !== undefined
                            ? {
                                set: prop.trade.entryTime,
                              }
                            : undefined,
                        exitTime:
                          prop.trade.exitTime !== undefined
                            ? {
                                set: prop.trade.exitTime,
                              }
                            : undefined,
                        pnlAmount:
                          prop.trade.pnlAmount !== undefined
                            ? {
                                set: prop.trade.pnlAmount,
                              }
                            : undefined,
                        pnlPercent:
                          prop.trade.pnlPercent !== undefined
                            ? {
                                set: prop.trade.pnlPercent,
                              }
                            : undefined,
                        durationMinutes:
                          prop.trade.durationMinutes !== undefined
                            ? {
                                set: prop.trade.durationMinutes,
                              }
                            : undefined,
                        marketPhase:
                          prop.trade.marketPhase !== undefined
                            ? {
                                set: prop.trade.marketPhase,
                              }
                            : undefined,
                        marketVolatility:
                          prop.trade.marketVolatility !== undefined
                            ? {
                                set: prop.trade.marketVolatility,
                              }
                            : undefined,
                        sessionHorizonMinutes:
                          prop.trade.sessionHorizonMinutes !== undefined
                            ? {
                                set: prop.trade.sessionHorizonMinutes,
                              }
                            : undefined,
                        thresholdsJson:
                          prop.trade.thresholdsJson !== undefined
                            ? {
                      ...
                      create: {
                        ...
                        confidence:
                          prop.trade.confidence !== undefined
                            ? prop.trade.confidence
                            : undefined,
                        timestamp:
                          prop.trade.timestamp !== undefined
                            ? prop.trade.timestamp
                            : undefined,
                        status:
                          prop.trade.status !== undefined
                            ? prop.trade.status
                        ...
                        entryPrice:
                          prop.trade.entryPrice !== undefined
                            ? prop.trade.entryPrice
                            : undefined,
                        exitPrice:
                          prop.trade.exitPrice !== undefined
                            ? prop.trade.exitPrice
                            : undefined,
                        entryQty:
                          prop.trade.entryQty !== undefined
                            ? prop.trade.entryQty
                        ...
                        entryValue:
                          prop.trade.entryValue !== undefined
                            ? prop.trade.entryValue
                            : undefined,
                        exitValue:
                          prop.trade.exitValue !== undefined
                            ? prop.trade.exitValue
                            : undefined,
                        entryTime:
                          prop.trade.entryTime !== undefined
                            ? prop.trade.entryTime
                            : undefined,
                        exitTime:
                          prop.trade.exitTime !== undefined
                            ? prop.trade.exitTime
                        ...
                        pnlAmount:
                          prop.trade.pnlAmount !== undefined
                            ? prop.trade.pnlAmount
                            : undefined,
                        pnlPercent:
                          prop.trade.pnlPercent !== undefined
                            ? prop.trade.pnlPercent
                            : undefined,
                        durationMinutes:
                          prop.trade.durationMinutes !== undefined
                            ? prop.trade.durationMinutes
                            : undefined,
                        marketPhase:
                          prop.trade.marketPhase !== undefined
                            ? prop.trade.marketPhase
                            : undefined,
                        marketVolatility:
                          prop.trade.marketVolatility !== undefined
                            ? prop.trade.marketVolatility
                            : undefined,
                        sessionHorizonMinutes:
                          prop.trade.sessionHorizonMinutes !== undefined
                            ? prop.trade.sessionHorizonMinutes
                            : undefined,
                        thresholdsJson:
                          prop.trade.thresholdsJson !== undefined
                            ? prop.trade.thresholdsJson
                            : undefined,
                      },
                    },
                  }

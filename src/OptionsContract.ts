...
export const OptionsContract = {
   ...
   */
  async create(
    props: OptionsContractType,
    globalClient?: ApolloClientType<NormalizedCacheObject>
  ): Promise<OptionsContractType> {
      ...
      try {
        ...
        const variables = {
          data: {
            ...
            contractSymbol:
              props.contractSymbol !== undefined
            ...
            inTheMoney:
              props.inTheMoney !== undefined ? props.inTheMoney : undefined,
            metadata: props.metadata !== undefined ? props.metadata : undefined,
            dataTimestamp:
              props.dataTimestamp !== undefined
                ? props.dataTimestamp
                : undefined,
            positions: props.positions
              ? Array.isArray(props.positions) &&
                props.positions.length > 0 &&
                props.positions.every(
                  (item: any) =>
                    typeof item === 'object' &&
                    'id' in item &&
                      ...
                      create: {
                        ...
                        strategyType:
                          item.strategyType !== undefined
                            ...
                            : undefined,
                        tradeId:
                          item.tradeId !== undefined ? item.tradeId : undefined,
                        metadata:
                        ...
                        executions: item.executions
                          ? Array.isArray(item.executions) &&
                            ...
                            : {
                                connectOrCreate: item.executions.map(
                                  (item: any) => ({
                                    where: {
                                      id:
                                        item.id !== undefined
                                    ...
                                    create: {
                                      ...
                                      contract: item.contract
                                        ? typeof item.contract === 'object' &&
                                          Object.keys(item.contract).length ===
                                            1 &&
            ...
            greeksHistory: props.greeksHistory
              ? Array.isArray(props.greeksHistory) &&
                props.greeksHistory.length > 0 &&
                props.greeksHistory.every(
                  (item: any) =>
                    typeof item === 'object' &&
                    'id' in item &&
                    Object.keys(item).length === 1
                      ...
                      create: {
                        timestamp:
                          item.timestamp !== undefined
                            ...
                            : undefined,
                        volume:
                          item.volume !== undefined ? item.volume : undefined,
                        openInterest:
                      ...
                      create: {
                        ...
                        position: item.position
                          ? typeof item.position === 'object' &&
                            Object.keys(item.position).length === 1 &&
                            ...
                            : {
                                connectOrCreate: {
                                  where: {
                                    id:
                                      item.position.id !== undefined
                                        ? item.position.id
                                        : undefined,
                                    alpacaAccountId:
                                      item.position.alpacaAccountId !==
                                      undefined
                                        ? {
                                            equals:
                                              item.position.alpacaAccountId,
                                        ...
                                        : undefined,
                                    contractId:
                                      item.position.contractId !== undefined
                                        ? {
                                  ...
                                  create: {
                                    alpacaAccountId:
                                      ...
                                      undefined
                                        ...
                                        : undefined,
                                    status:
                                      item.position.status !== undefined
                                        ? item.position.status
                                        : undefined,
                                    openingSide:
                                      item.position.openingSide !== undefined
                                        ? item.position.openingSide
                                        : undefined,
                                    quantity:
                                      item.position.quantity !== undefined
                                        ? item.position.quantity
                                        : undefined,
                                    entryTime:
                                      item.position.entryTime !== undefined
                                        ? item.position.entryTime
                                        : undefined,
                                    exitTime:
                                      item.position.exitTime !== undefined
                                        ? item.position.exitTime
                                        : undefined,
                                    daysHeld:
                                      item.position.daysHeld !== undefined
                                        ? item.position.daysHeld
                                        : undefined,
                                    exitReason:
                                      item.position.exitReason !== undefined
                                        ? item.position.exitReason
                                        : undefined,
                                    strategyType:
                                      item.position.strategyType !== undefined
                                        ? item.position.strategyType
                                        : undefined,
                                    tradeId:
                                      item.position.tradeId !== undefined
                                        ? item.position.tradeId
                                        : undefined,
                                    metadata:
                                      item.position.metadata !== undefined
                                        ? item.position.metadata
                                        : undefined,
                                    contract: item.position.contract
                                      ? typeof item.position.contract ===
                                          'object' &&
                                        Object.keys(item.position.contract)
                                          .length === 1 &&
                                        Object.keys(
                                          item.position.contract
                                        )[0] === 'id'
                                        ? {
                                            connect: {
        ...
        if (
          response &&
          response.data &&
          response.data.createOneOptionsContract
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const CREATE_MANY_OPTIONSCONTRACT = gql`
          mutation createManyOptionsContract(
            $data: [OptionsContractCreateManyInput!]!
          ) {
        ...
        const variables = {
          data: props.map((prop) => ({
            ...
            inTheMoney:
              prop.inTheMoney !== undefined ? prop.inTheMoney : undefined,
            metadata: prop.metadata !== undefined ? prop.metadata : undefined,
            dataTimestamp:
              prop.dataTimestamp !== undefined ? prop.dataTimestamp : undefined,
          })),
        };
        ...
        if (
          response &&
          response.data &&
          response.data.createManyOptionsContract
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
          ...
          data: {
            ...
            askPrice:
              props.askPrice !== undefined
                ...
                : undefined,
            midPrice:
              props.midPrice !== undefined
                ? {
                    set: props.midPrice,
                  }
                : undefined,
            bidSize:
              props.bidSize !== undefined
                ? {
                    set: props.bidSize,
                  }
                : undefined,
            askSize:
              props.askSize !== undefined
                ? {
                    set: props.askSize,
                  }
                : undefined,
            ...
            extrinsicValue:
              props.extrinsicValue !== undefined
                ...
                : undefined,
            theoreticalPrice:
              props.theoreticalPrice !== undefined
                ? {
                      ...
                      update: {
                        ...
                        currentRho:
                          item.currentRho !== undefined
                            ...
                            : undefined,
                        currentImpliedVolatility:
                          item.currentImpliedVolatility !== undefined
                            ? {
                      ...
                      update: {
                        ...
                        position: item.position
                          ? typeof item.position === 'object' &&
                            Object.keys(item.position).length === 1 &&
                            (Object.keys(item.position)[0] === 'id' ||
                              Object.keys(item.position)[0] === 'symbol')
                            ? {
                                connect: {
                                  id: item.position.id,
                                },
                                  ...
                                  update: {
                                    ...
                                    quantity:
                                      item.position.quantity !== undefined
                                        ...
                                        : undefined,
                                    entryPrice:
                                      item.position.entryPrice !== undefined
                                        ? {
                                            set: item.position.entryPrice,
                                          }
                                        : undefined,
                                    entryCost:
                                      item.position.entryCost !== undefined
                                        ? {
                                    ...
                                    entryTime:
                                      item.position.entryTime !== undefined
                                        ...
                                        : undefined,
                                    exitPrice:
                                      item.position.exitPrice !== undefined
                                        ? {
                                            set: item.position.exitPrice,
                                          }
                                        : undefined,
                                    exitValue:
                                      item.position.exitValue !== undefined
                                        ? {
                                    ...
                                    exitTime:
                                      item.position.exitTime !== undefined
                                        ...
                                        : undefined,
                                    currentPrice:
                                      item.position.currentPrice !== undefined
                                        ? {
                                            set: item.position.currentPrice,
                                          }
                                        : undefined,
                                    currentValue:
                                      item.position.currentValue !== undefined
                                        ? {
                                            set: item.position.currentValue,
                                          }
                                        : undefined,
                                    unrealizedPnL:
                                      item.position.unrealizedPnL !== undefined
                                        ? {
                                            set: item.position.unrealizedPnL,
                                          }
                                        : undefined,
                                    unrealizedPnLPercent:
                                      item.position.unrealizedPnLPercent !==
                                      undefined
                                        ? {
                                            set: item.position
                                              .unrealizedPnLPercent,
                                        ...
                                        : undefined,
                                    realizedPnL:
                                      item.position.realizedPnL !== undefined
                                        ? {
                                            set: item.position.realizedPnL,
                                          }
                                        : undefined,
                                    realizedPnLPercent:
                                      item.position.realizedPnLPercent !==
                                      undefined
                                        ? {
                                            set: item.position
                                              .realizedPnLPercent,
                                        ...
                                        : undefined,
                                    totalFees:
                                      item.position.totalFees !== undefined
                                        ? {
                                            set: item.position.totalFees,
                                          }
                                        : undefined,
                                    currentDelta:
                                      item.position.currentDelta !== undefined
                                        ? {
                                            set: item.position.currentDelta,
                                          }
                                        : undefined,
                                    currentGamma:
                                      item.position.currentGamma !== undefined
                                        ? {
                                            set: item.position.currentGamma,
                                          }
                                        : undefined,
                                    currentTheta:
                                      item.position.currentTheta !== undefined
                                        ? {
                                            set: item.position.currentTheta,
                                          }
                                        : undefined,
                                    currentVega:
                                      item.position.currentVega !== undefined
                                        ? {
                                            set: item.position.currentVega,
                                          }
                                        : undefined,
                                    currentRho:
                                      item.position.currentRho !== undefined
                                        ? {
                                            set: item.position.currentRho,
                                          }
                                        : undefined,
                                    currentImpliedVolatility:
                                      item.position.currentImpliedVolatility !==
                                      undefined
                                        ? {
                                            set: item.position
                                              .currentImpliedVolatility,
        ...
        if (
          response &&
          response.data &&
          response.data.updateOneOptionsContract
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        if (
          response &&
          response.data &&
          response.data.upsertOneOptionsContract
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const UPDATE_MANY_OPTIONSCONTRACT = gql`
          mutation updateManyOptionsContract(
            $data: [OptionsContractCreateManyInput!]!
          ) {
          ...
          data: {
            ...
            askPrice:
              prop.askPrice !== undefined
                ...
                : undefined,
            midPrice:
              prop.midPrice !== undefined
                ? {
                    set: prop.midPrice,
                  }
                : undefined,
            bidSize:
              prop.bidSize !== undefined
                ? {
                    set: prop.bidSize,
                  }
                : undefined,
            askSize:
              prop.askSize !== undefined
                ? {
                    set: prop.askSize,
                  }
                : undefined,
            ...
            extrinsicValue:
              prop.extrinsicValue !== undefined
                ...
                : undefined,
            theoreticalPrice:
              prop.theoreticalPrice !== undefined
                ? {
            ...
            positions: prop.positions
              ? Array.isArray(prop.positions) &&
                prop.positions.length > 0 &&
            ...
            greeksHistory: prop.greeksHistory
              ? Array.isArray(prop.greeksHistory) &&
                prop.greeksHistory.length > 0 &&
                prop.greeksHistory.every(
                  (item: any) =>
                    typeof item === 'object' &&
                    ('id' in item || 'symbol' in item) &&
                    Object.keys(item).length === 1
        ...
        if (
          response &&
          response.data &&
          response.data.updateManyOptionsContract
        ) {
    ...
    while (retryCount < MAX_RETRIES) {
      try {
        ...
        const DELETE_ONE_OPTIONSCONTRACT = gql`
          mutation deleteOneOptionsContract(
            $where: OptionsContractWhereUniqueInput!
          ) {
        ...
        if (
          response &&
          response.data &&
          response.data.deleteOneOptionsContract
        ) {
  ...
  async get(
    ...
    globalClient?: ApolloClientType<NormalizedCacheObject>,
    whereInput?: any
  ): Promise<OptionsContractType | null> {
    // Maximum number of retries for database connection issues
    const MAX_RETRIES = 3;
    let retryCount = 0;
    let lastError: any = null;

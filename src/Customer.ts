...
id
 ...
 : { connectOrCreate: item.authenticators.map((item: any) => ({
    ...
    orgMemberships: item.orgMemberships ? 
      Array.isArray(item.orgMemberships) && item.orgMemberships.length > 0 &&  item.orgMemberships.every((item: any) => typeof item === 'object' && 'id' in item && Object.keys(item).length === 1) ? {
        connect:      item.orgMemberships.map((item: any) => ({
           id: item.id
        }))
 }
 : { connectOrCreate: item.orgMemberships.map((item: any) => ({
        where: {
          id: item.id !== undefined ? item.id : undefined,
    ...
    fundAssignments: item.fundAssignments ? 
      Array.isArray(item.fundAssignments) && item.fundAssignments.length > 0 &&  item.fundAssignments.every((item: any) => typeof item === 'object' && 'id' in item && Object.keys(item).length === 1) ? {
        connect:      item.fundAssignments.map((item: any) => ({
           id: item.id
        }))
 }
 : { connectOrCreate: item.fundAssignments.map((item: any) => ({
        where: {
          id: item.id !== undefined ? item.id : undefined,
    ...
    investorProfile: item.investorProfile ? 
      typeof item.investorProfile === 'object' && Object.keys(item.investorProfile).length === 1 && Object.keys(item.investorProfile)[0] === 'id'
    ? { connect: {
    ...
    : { connectOrCreate: {
        where: {
          id: item.investorProfile.id !== undefined ? item.investorProfile.id : undefined,
          userId: item.investorProfile.userId !== undefined ? item.investorProfile.userId : undefined,
          name: item.investorProfile.name !== undefined ? {
              equals: item.investorProfile.name 
             } : undefined,
          email: item.investorProfile.email !== undefined ? {
              equals: item.investorProfile.email 
             } : undefined,
        },
        create: {
          name: item.investorProfile.name !== undefined ? item.investorProfile.name : undefined,
          email: item.investorProfile.email !== undefined ? item.investorProfile.email : undefined,
          type: item.investorProfile.type !== undefined ? item.investorProfile.type : undefined,
          kycStatus: item.investorProfile.kycStatus !== undefined ? item.investorProfile.kycStatus : undefined,
          walletAddress: item.investorProfile.walletAddress !== undefined ? item.investorProfile.walletAddress : undefined,
          deletedAt: item.investorProfile.deletedAt !== undefined ? item.investorProfile.deletedAt : undefined,
      investments: item.investorProfile.investments ? 
        Array.isArray(item.investorProfile.investments) && item.investorProfile.investments.length > 0 &&  item.investorProfile.investments.every((item: any) => typeof item === 'object' && 'id' in item && Object.keys(item).length === 1) ? {
          connect:        item.investorProfile.investments.map((item: any) => ({
             id: item.id
          }))
 }
 : { connectOrCreate: item.investorProfile.investments.map((item: any) => ({
          where: {
            id: item.id !== undefined ? item.id : undefined,
            fundId: item.fundId !== undefined ? {
                equals: item.fundId 
 ...
 : { connectOrCreate: item.reviewedWaitlistEntries.map((item: any) => ({
  ...
  connect: props.users.map((item: any) => ({
    ...
    orgMemberships: item.orgMemberships ? 
    Array.isArray(item.orgMemberships) && item.orgMemberships.length > 0 && item.orgMemberships.every((item: any) => typeof item === 'object' && ('id' in item || 'symbol' in item) && Object.keys(item).length === 1) ? {
    connect: item.orgMemberships.map((item: any) => ({
      id: item.id
    }))
} : { upsert: item.orgMemberships.map((item: any) => ({
        where: {
          id: item.id !== undefined ? item.id : undefined,
          organizationId: item.organizationId !== undefined ? {
              equals: item.organizationId
...
? {
    ...
    fundAssignments: item.fundAssignments ? 
    Array.isArray(item.fundAssignments) && item.fundAssignments.length > 0 && item.fundAssignments.every((item: any) => typeof item === 'object' && ('id' in item || 'symbol' in item) && Object.keys(item).length === 1) ? {
    connect: item.fundAssignments.map((item: any) => ({
      id: item.id
    }))
} : { upsert: item.fundAssignments.map((item: any) => ({
        where: {
          id: item.id !== undefined ? item.id : undefined,
          fundId: item.fundId !== undefined ? {
              equals: item.fundId
...
? {
    ...
    investorProfile: item.investorProfile ? 
    typeof item.investorProfile === 'object' && Object.keys(item.investorProfile).length === 1 && (Object.keys(item.investorProfile)[0] === 'id' || Object.keys(item.investorProfile)[0] === 'symbol')
? {
    connect: {
      id: item.investorProfile.id
    }
        ...
        where: {
          id: item.investorProfile.id !== undefined ? {
          ...
          userId: item.investorProfile.userId !== undefined ? {
        ...
        update: {
          ...
          type: item.investorProfile.type !== undefined ? {
              set: item.investorProfile.type
            } : undefined,
          kycStatus: item.investorProfile.kycStatus !== undefined ? {
              set: item.investorProfile.kycStatus
            } : undefined,
          walletAddress: item.investorProfile.walletAddress !== undefined ? {
              set: item.investorProfile.walletAddress
            } : undefined,
          deletedAt: item.investorProfile.deletedAt !== undefined ? {
              set: item.investorProfile.deletedAt
            } : undefined,
      investments: item.investorProfile.investments ? 
      Array.isArray(item.investorProfile.investments) && item.investorProfile.investments.length > 0 && item.investorProfile.investments.every((item: any) => typeof item === 'object' && ('id' in item || 'symbol' in item) && Object.keys(item).length === 1) ? {
      connect: item.investorProfile.investments.map((item: any) => ({
        id: item.id
      }))
} : { upsert: item.investorProfile.investments.map((item: any) => ({
          where: {
            id: item.id !== undefined ? item.id : undefined,
            fundId: item.fundId !== undefined ? {
                equals: item.fundId
